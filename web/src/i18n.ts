...
const strings = {
  ru: {
    ...
    highlights: [
      ...
      },
      {
        ...
        text: 'С правом phone:read мини-приложение запрашивает у приложения подтверждённый номер.',
      },
    ],
  ...
  kk: {
    ...
    highlights: [
      ...
      {
        title: 'Нөмірді беру',
        text: 'phone:read рұқсаты болса, мини-қосымша расталған нөмірді қосымшадан сұрайды.',
      },
    ],
